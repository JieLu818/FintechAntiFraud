...
class FeatureDerivative:
    ...
    def add_avg_feature(self, data, periods=None, denominator_col='_pay_times', numerator_col='_Sum_pay_amount',
    ...
    def add_prd_change_feature(self, data, periods=None, input_str='_Avg_pay_amount', output_str='_payment_increase', ):
        if periods is None:
            periods = PERIODS
        tmp_data = data.copy()
    ...
    def avg_payment_derivative(self, data, periods=None, ):
        if periods is None:
            periods = PERIODS
        tmp_data = data.copy()
